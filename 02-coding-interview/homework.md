...
We're going to implement a platform for online coding interviews. The app should be able to do the following:
...
What are your recommendations for frontend and backend implementation?
