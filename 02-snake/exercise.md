...
Notes!
Claude struggled mightily with the CSS and getting login/screen active switching to work
Lovable did better but I could not connect a project in Github, and I wasn't interested in manually exporting all the files it generated.
