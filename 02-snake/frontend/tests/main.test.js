...
describe('SnakeApp Keyboard Controls', () => {
    ...
    beforeEach(() => {
        ...
        app = {
            ...
            startGame: jest.fn(function() {
                this.game.isRunning = true;
                this.game.start();
            }),

            pauseGame: jest.fn(function() {
                this.game.pause();
            }),

            playAgain: jest.fn(function() {
    ...
    describe('Game Mode Reset on Login', () => {
        ...
        it('should reset game mode to walls when user logs in', () => {
            ...
            const passThroughRadio = document.querySelector('input[name="mode"][value="pass-through"]');
            ...
            const wallsRadioAfterLogin = document.querySelector('input[name="mode"][value="walls"]');
        ...
        it('should initialize game with walls mode after login', () => {
            ...
            const mockSnakeGame = jest.fn(function(canvas, config) {
            ...
            const game = new mockSnakeGame(canvas, {
                gridSize: 20,
                mode: 'walls',
                speed: 150
            });
